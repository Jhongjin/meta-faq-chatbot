...
[시스템 정보]
검색결과: 관련 내부 문서를 찾을 수 없음
챗봇신뢰도: 정보 부족으로 답변 불가
추천조치: ${category.recommendedAction}
...
[연락처 정보]
회신주소: fb@nasmedia.co.kr
시스템관리: Meta FAQ 챗봇 관리팀
...
export async function POST(request: NextRequest) {
  try {
    ...
    // URL 길이가 너무 길면 간소화된 버전 사용 (더 엄격한 제한)
    if (emailLink.length > 1500) {
